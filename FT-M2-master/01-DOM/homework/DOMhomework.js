...
function buildToDo(todo, index) {
  // Tu código acá:
let toDoShell=document.createElement("div"); //creo un div y lo asigno a todoshell
...
function addToDo() {
  ...
  if(toDoInput.value){ //si no esta vacio
...
//que tome el click de un enter para crear una nueva taera
